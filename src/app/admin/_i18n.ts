...
const DE = {
  ...
  sectionMycakeday: "MyCakeDay",
  navMycakedayPostfach: "Postfach",
  navMycakedayUebersicht: "Übersicht",
  navMycakedayFirmen: "Firmen",
  navMycakedayPartner: "Partner",
  navMycakedaySortiment: "Sortiment",
  navMycakedayMitteilungen: "Mitteilungen",
  navExternalHint: "Öffnet mycakeday.ch in einem neuen Tab, ohne zweiten Login",
  ...
  flashAscBadKey: "App Store Connect: Issuer-ID, Key-ID oder .p8 stimmt nicht. Nichts gespeichert.",
  ...
  fieldAscIssuer: "Issuer ID (ASC → Benutzer und Zugriffsrechte → Integration)",
  fieldAscKeyId: "Key-ID (10 Zeichen, Spalte „Schlüssel-ID“)",
  fieldAscP8: "Privater Schlüssel — kompletter Inhalt der AuthKey_….p8",
  ascHint:
    "App Store Connect nimmt keinen festen Token: der Proxy signiert pro Anfrage ein 15-Minuten-JWT aus diesen drei Angaben. Die .p8 lädt Apple nur einmal herunter.",
...
const EN: AdminMessages = {
  ...
  navMycakeday: "MyCakeDay",
  sectionMycakeday: "MyCakeDay",
  navMycakedayPostfach: "Mailbox",
  navMycakedayUebersicht: "Overview",
  navMycakedayFirmen: "Companies",
  navMycakedayPartner: "Partners",
  navMycakedaySortiment: "Assortment",
  navMycakedayMitteilungen: "Notices",
  navExternalHint: "Opens mycakeday.ch in a new tab, no second login",
  navOutreach: "Outreach",
  navContent: "Content",
  navBookings: "Bookings",
  navCal: "Cal admin",
  ...
  flashAscBadKey: "App Store Connect: issuer id, key id or .p8 is wrong. Nothing was saved.",
  ...
  fieldAscIssuer: "Issuer ID (ASC → Users and Access → Integrations)",
  fieldAscKeyId: "Key ID (10 characters, the “Key ID” column)",
  fieldAscP8: "Private key — full contents of AuthKey_….p8",
  ascHint:
    "App Store Connect takes no static token: the proxy signs a 15-minute JWT per request from these three values. Apple lets you download the .p8 only once.",
