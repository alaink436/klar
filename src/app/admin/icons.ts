// Inline lucide-style SVGs for the admin nav. Client-safe COPY of the ICON set
// in _shared.ts, kept in its own dependency-free module so the client component
// AdminSidebar can use it WITHOUT pulling _shared's server-only deps into the
// client bundle. Keep these two in sync (they rarely change). Server code keeps
// importing ICON from _shared as before.
export const ICON: Record<string, string> = {
  ...
  creators:
    `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M19 8v6"/><path d="M22 11h-6"/></svg>`,
};
