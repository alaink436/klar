...
export default function Home() {
  return (
    <main className="min-h-screen relative bg-[var(--bg)]">
      {/* ─────────── NAV ─────────── */}
      <nav className="flex items-center justify-between px-4 sm:px-6 md:px-12 py-4 md:py-5 border-b border-[var(--line)] relative z-20 bg-[var(--bg)]">
        <div className="flex items-baseline gap-2 sm:gap-3">
          <span className="display text-xl sm:text-2xl">klar</span>
          <span className="label hidden sm:inline">v0.3 · ch</span>
        </div>
      ...
      {/* ─────────── HERO (with liquid-metal window) ─────────── */}
      <section className="relative px-4 sm:px-6 md:px-12 pt-12 sm:pt-20 md:pt-32 pb-16 sm:pb-24 md:pb-36 overflow-hidden border-b border-[var(--line)]">
        {/* The liquid-metal window — only here, fades into solid bg */}
        <div className="hero-window" aria-hidden="true">
          <div
            className="hero-bg-layer hero-bg-1"
            style={{ backgroundImage: "url('/bg/bg-1.jpg')" }}
          />
          <div
            className="hero-bg-layer hero-bg-2"
            style={{ backgroundImage: "url('/bg/bg-2.jpg')" }}
          />
          <div className="hero-window-fade" />
        </div>
        ...
        <div className="relative z-10">
          ...
          <h1 className="display t-wordmark text-[var(--fg)] -ml-1 sm:-ml-2">
            klar
          </h1>
      ...
      <section
        id="apps"
        className="px-4 sm:px-6 md:px-12 py-14 sm:py-20 md:py-28 border-b border-[var(--line)] relative z-10 bg-[var(--bg)]"
      >
      ...
      {/* ─────────── FOOTER ─────────── */}
      <footer className="px-4 sm:px-6 md:px-12 py-8 sm:py-12 relative z-10 bg-[var(--bg)]">
        <div className="grid grid-cols-12 gap-6 sm:gap-8 mb-6 sm:mb-10">
          <div className="col-span-12 md:col-span-6">
            <div className="flex items-baseline gap-3 mb-2">
              ...
              <span className="label">v0.3</span>
            </div>
