// Kelva affiliate-onboarding hosted on getklar.org. Unified Klar
// public-site look — identical to the other apps, only the topframe icon
// switches via /icons/kelva-v3.webp.
...
export default function KelvaSetupPage({ params }: { params: Promise<{ token: string }> }) {
