...
export const BRANDS: Record<BrandKey, Brand> = {
  yarnstash: {
    ...
    iconUrl: "/icons/yarnstash-v3.webp",
  ...
  wavelength: {
    ...
    short: "Basalt",
    accent: "Sage",
    vibe: "Dark, restrained, one quiet accent. No shame, no cheerleading.",
    productLine: "One goal at a time, enforced",
    audience: "16-30, quitting porn or doomscrolling, or building a training habit",
