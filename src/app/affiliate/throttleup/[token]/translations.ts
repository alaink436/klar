...
const de: T = {
  ...
  welcome_body: "Willkommen im ThrottleUp Affiliate-Programm. Vier kurze Schritte, dann ist dein Tracking-Link live.",
  ...
  nav_back: "Zurück",
  nav_next: "Weiter",
  welcome_what_title: "Was ist ThrottleUp",
...
const en: T = {
  ...
  tag: "ThrottleUp · Onboarding",
  welcome_title: "Hi @{handle},",
  welcome_body: "Welcome to the ThrottleUp affiliate program. Four short steps, then your tracking link is live.",
  ...
  nav_back: "Back",
  nav_next: "Next",
  welcome_what_title: "What is ThrottleUp",
...
const fr: T = {
  ...
  welcome_body: "Bienvenue dans le programme affilié ThrottleUp. Quatre courtes étapes, puis ton lien est en ligne.",
...
const es: T = {
  ...
  welcome_body: "Bienvenida al programa de afiliados ThrottleUp. Cuatro pasos cortos y tu enlace está en vivo.",
...
const it: T = {
  ...
  welcome_body: "Benvenuto nel programma affiliato ThrottleUp. Quattro passi brevi, poi il tuo link è live.",
...
const nl: T = {
  ...
  tag: "ThrottleUp · Onboarding",
  welcome_title: "Hi @{handle},",
  welcome_body: "Welkom bij het ThrottleUp affiliate-programma. Vier korte stappen en je link is live.",
